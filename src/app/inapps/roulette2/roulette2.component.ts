...
const symbolSegments: any = {
  1: '¡Felicidades! ganaste 10% gratis en cerveza con el cupón 10encerveza. Descarga la app y canjéalo',
  2: '¡Felicidades! ganaste $2 gratis en cerveza con el cupón dolarcerveza. Descarga la app y canjéalo',
  3: 'Lo Sentimos, Sigue participando',
  4: '¡Felicidades! ganaste 5% gratis en cerveza con el cupón 5magicos. Descarga la app y canjéalo',
  5: '¡Felicidades! ganaste 12% gratis en cerveza con el cupón 15encerveza. Descarga la app y canjéalo',
...
@Component({
  selector: 'app-roulette-2',
  templateUrl: './roulette2.component.html',
  styleUrls: ['./roulette2.component.css'],
})
export class RouletteComponent2 implements OnInit {
  constructor() {}
